...
mt_window_action_about(GSimpleAction *action, GVariant *parameter, gpointer user_data)
{
    ...
    adw_about_window_set_application_name(about, "Vellum");
    adw_about_window_set_application_icon(about, "io.github.vellum.Vellum");
    adw_about_window_set_developer_name(about, "Vellum contributors");
    adw_about_window_set_comments(about, _("A focused GTK4 text editor."));
    adw_about_window_set_license_type(about, GTK_LICENSE_BSD);
    gtk_window_set_transient_for(GTK_WINDOW(about), GTK_WINDOW(window->window));
